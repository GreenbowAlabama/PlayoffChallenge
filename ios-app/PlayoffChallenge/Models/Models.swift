...
// Production code should use Core types instead
...
@_exported import enum Core.LeaderboardComputationState
...
// MARK: - Presentation Extensions

extension ContestStatus {
    /// Human-readable display name (e.g. "Scheduled", "Live").
    /// Views use this instead of touching rawValue directly.
    var displayName: String {
