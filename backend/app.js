...
const adminTemplatesRoutes = require('./routes/admin.templates.routes');
const adminTournamentsRoutes = require('./routes/admin.tournaments.routes');
const adminOrphanedFundsRoutes = require('./routes/admin.orphaned-funds.routes');
...
const financialOpsRoutes = require('./routes/admin/financial-ops.routes');
const pgaDiagnosticsRoutes = require('./routes/admin/pga-diagnostics.routes');
...
app.use('/api/admin/orphaned-funds', adminOrphanedFundsRoutes);
...
app.use('/api/admin/user-ops', userOpsRoutes);
app.use('/api/admin/financial-ops', financialOpsRoutes);
app.use('/api/admin/pga', pgaDiagnosticsRoutes);
